...
// Predefined hints for common game mechanics
export const GAME_HINTS = {
  // Business hints
  BUSINESS_ROI: {
    title: "Return on Investment",
    hint: "ROI shows how profitable a business is. Higher ROI means better returns on your investment. Consider both initial cost and ongoing income.",
    type: "tip",
    wikiLink: "/docs/wiki/Business-Categories.md"
  },

  BUSINESS_UPGRADE: {
    title: "Business Upgrades",
    hint: "Upgrading businesses increases their income but costs more. Calculate if the extra income justifies the upgrade cost.",
    type: "help",
    wikiLink: "/docs/wiki/Business-Upgrades.md"
  },

  SUPPLY_CHAIN: {
    title: "Supply Chain",
    hint: "Some businesses depend on others. Owning the supply chain can reduce costs by 15-25% and increase profits.",
    type: "tip",
    wikiLink: "/docs/wiki/Supply-Chain.md"
  },

  // Staking hints
  STAKING_POOLS: {
    title: "Staking Pools",
    hint: "Different pools offer different APY rates and lock periods. Higher APY usually means higher risk or longer lock times.",
    type: "info",
    wikiLink: "/docs/wiki/Staking-Pools.md"
  },

  GOVERNANCE_POWER: {
    title: "Governance Power",
    hint: "Your voting power = (Staked TON × Tenure) + Achievement Bonuses + Economic Class Bonuses. Stake more to influence decisions.",
    type: "help",
    wikiLink: "/docs/wiki/Governance-Guide.md"
  },

  // Economic hints
  MARKET_EVENTS: {
    title: "Market Events",
    hint: "Economic events can boost or hurt your businesses. Stakers get protection during crashes and bonuses during booms.",
    type: "tip",
    wikiLink: "/docs/wiki/Economic-Events.md"
  },

  INFLATION: {
    title: "Inflation System",
    hint: "Base inflation is 2% monthly, but community staking reduces it for everyone. Stakers get partial protection.",
    type: "info",
    wikiLink: "/docs/wiki/Inflation-System.md"
  },

  // Career hints
  EDUCATION: {
    title: "Education Benefits",
    hint: "Higher education unlocks better jobs with higher salaries. College and certifications are investments in your future.",
    type: "tip",
    wikiLink: "/docs/wiki/Career-Development.md"
  },

  CREDIT_SCORE: {
    title: "Credit Score",
    hint: "Good credit (700+) unlocks better loans and lower interest rates. Pay bills on time and keep debt low.",
    type: "help",
    wikiLink: "/docs/wiki/Banking-Finance.md"
  },

  // Social hints
  RELATIONSHIPS: {
    title: "Relationship Benefits",
    hint: "Strong relationships provide networking opportunities, job referrals, and emotional support that affects your performance.",
    type: "tip",
    wikiLink: "/docs/wiki/Relationships.md"
  },

  REFERRALS: {
    title: "Referral System",
    hint: "Invite friends to earn 500 points immediately plus 5% commission on their earnings for 30 days.",
    type: "info"
  }
};

// Quick hint component for specific game mechanics
export const QuickHint = ({ hintKey, ...props }) => {
  const hintData = GAME_HINTS[hintKey];
  if (!hintData) return null;

  return <HintIcon {...hintData} {...props} />;
};
